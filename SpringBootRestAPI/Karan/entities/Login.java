...
public class Login {
	...
	public Login(String username, String password, Company company, Roles roles, boolean forgetpass_status,
			boolean setup_status) {
		super();
	...
	public Login(int login_id, String username, String password, Company company, Roles roles, boolean forgetpass_status,
			boolean setup_status) {
		super();
	...
	public Login(String username, String password, Company company, Roles roles) {
		super();
		this.username = username;
		this.password = password;
		this.company = company;
