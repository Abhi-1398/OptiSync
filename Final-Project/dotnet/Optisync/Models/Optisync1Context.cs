...
public partial class Optisync1Context : DbContext
{
    public Optisync1Context()
    {
    }

    public Optisync1Context(DbContextOptions<Optisync1Context> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<LoginSeq> LoginSeqs { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=localhost;port=3306;user=root;password=root;database=optisync1", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.31-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<LoginSeq>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("login_seq");
