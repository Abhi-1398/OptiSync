...
public class ProductionDummy {
	...
	public ProductionDummy(int order_id, int raw_material_id, int received_qty, Date date, int target_value,
	...
	public ProductionDummy(int raw_material_id, int received_qty, Date date, int target_value, int achieve,
			int current_qty, String operator_name, int machine_id) {
		super();
		this.raw_material_id = raw_material_id;
		this.received_qty = received_qty;
		this.date = date;
